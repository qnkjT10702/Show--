...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div style="width:340px;height:300px;opacity:0.9;text-align:center;position:relative;left:686px;top:55px;background-color:white;">
            <asp:Label ID="LabName" runat="server" Text="Label" style="font-size:14px; position:absolute; left:55px; top:22px;">真&nbsp;实&nbsp;姓&nbsp;名</asp:Label>
            ...
            <asp:RequiredFieldValidator ID="RequName" runat="server" ControlToValidate="TxtName" EnableClientScript="false" ErrorMessage="真实姓名不可以为空" ForeColor="Red"></asp:RequiredFieldValidator>
            <br />
            ...
            <asp:TextBox ID="TxtAginPwd" runat="server" style="padding:0px 10px;box-sizing:border-box;width:150px;margin-left:10px;height:20px;border-radius:10px;border:1px solid black;"></asp:TextBox>
              <asp:RequiredFieldValidator ID="RequAginPwd" runat="server" ControlToValidate="TxtAginPwd" EnableClientScript="false" ErrorMessage="请再次确认密码" ForeColor="Red"></asp:RequiredFieldValidator>
            <br />
            <br />
