...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="overflow:hidden;background-image:url(../Imgs/lx6.jpg);background-size:100% 100%;">
        <div id="Bigbox" style="position:relative;left:580px;top:30px;width:500px;height:700px;overflow-y:hidden;">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server"   ForeColor="#ff3300" ControlToValidate="FileMicSRc" ErrorMessage="歌曲路径不可以为空" EnableClientScript="false" style="font-size:13px;"></asp:RequiredFieldValidator>
            <br  runat="server"/>
